...
test("Top Pins readiness DTO validation is exact, frozen, bounded, row-local, and private-field free",()=>{
  ...
  assert.deepEqual(state.topPins.pins,[
    {title:"<img src=x onerror=private()>",boardName:"Board",impressions:100,saves:2,pinClicks:3,outboundClicks:4,contentReadiness:ready,contentReadinessDetails:{required:[],review:[]}},
    {title:"Attention",boardName:"Board",impressions:100,saves:2,pinClicks:3,outboundClicks:4,contentReadiness:attention,contentReadinessDetails:{required:["Add a Pin title."],review:["Add a Pin description for Pinterest relevance.","Add or repair the Pin image."]}},
    {title:"Unavailable",boardName:"Board",impressions:100,saves:2,pinClicks:3,outboundClicks:4,contentReadiness:null,contentReadinessDetails:null},
  ]);
